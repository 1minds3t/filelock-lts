...
```bash
pip install filelock-lts-py38==2026.22701
```
...
pip show filelock filelock-lts-py38
```
...
pip show filelock
# Should show NO result, or only show filelock-lts / filelock-lts-py38
...
> `filelock-lts-py38>=2026.22701` to ensure your users receive the patched version.
