# Filelock LTS (lts-py314) - ➡️ REDIRECT
...
This package ensures you are using a secure version of filelock on Python 3.14.

Since Python 3.14 is supported by the official upstream maintainers, this LTS package acts as a **Meta-Package / Proxy**.
...
```bash
pip install filelock-lts-lts-py314
```
